...
void insertionsort(int a[],int n,int count,int ch)
{
    ...
    for(int i=0;i<n;i++)
        cout<<a[i]<<"\t";
    if(ch==1)
        cout<<"Number of comparisions in ascending order = "<<count<<"\n";
    else if(ch==2)
        cout<<"Number of comparisions in descending order = "<<count<<"\n";
    else
        cout<<"Number of comparisions in random order = "<<count<<"\n";
}
int main()
{
    int ch,n,count=0;
